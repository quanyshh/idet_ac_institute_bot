...
from db_commands import add_degrees, add_institutes, add_departments, add_question, add_specialities
...
async def add_data():
    ...
    #intitute 3 department 13
    await add_specialities(
        speciality_name = "6B07302- Строительство",
    ...
    await add_specialities(
        speciality_name = "6В07303- Производство строительных материалов изделии и конструкции",
    ...
    await add_specialities(
        speciality_name = "76М072900- Строительство",
    ...
    await add_specialities(
        speciality_name = "6М073000 - Производство строительных материалов изделии и конструкции",
    ...
    await add_question(
            question_name = "Первод в Satbayev University",
